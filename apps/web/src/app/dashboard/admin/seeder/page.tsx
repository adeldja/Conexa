...
export default function AdminSeederPage() {
  ...
  const seedActions = [
    {
      ...
      description:
        'Ajoute les spécialités de base (Coaching sportif, Consultation juridique, etc.)',
      color: 'blue',
      icon: '🏷️',
    },
    {
  ...
  const getButtonClasses = (color: string) => {
    const baseClasses =
      'w-full px-4 py-2 rounded-lg font-medium transition-colors disabled:opacity-50';
    const colorClasses = {
