    ...
    return (
      <button
        className={cn(
          ...
          // Variant classes
          {
            'bg-gradient-to-r from-[#1D4FFF] to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 focus:ring-[#1D4FFF]/50 shadow-lg hover:shadow-xl':
              variant === 'primary',
            'bg-slate-100 text-slate-700 hover:bg-slate-200 focus:ring-slate-500':
              variant === 'secondary',
            'border-2 border-slate-200 bg-white text-slate-700 hover:bg-slate-50 focus:ring-slate-500':
              variant === 'outline',
