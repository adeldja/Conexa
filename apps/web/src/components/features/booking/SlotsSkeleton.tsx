                ...
                <div className="flex items-center space-x-4">
                  <div className="hidden md:flex items-center space-x-2">
                    {Array.from({ length: 3 }).map((_, badgeIndex) => (
                      <div key={badgeIndex} className="px-3 py-1.5 bg-gray-200 rounded-full animate-pulse">
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Array.from({ length: slotsPerDay }).map((_, slotIndex) => (
                <div key={slotIndex} className="border-2 border-gray-100 rounded-2xl p-6 animate-pulse">
