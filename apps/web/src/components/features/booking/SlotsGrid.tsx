...
export default function SlotsGrid({ slots, onBookSlot, loading, loadingSlots }: SlotsGridProps) {
          ...
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm mt-2">
                Recherche des disponibilités du prestataire
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <p className="text-gray-600 text-center max-w-md leading-relaxed">
            Ce prestataire n'a pas de créneaux disponibles pour le moment. Essayez de sélectionner
            un autre prestataire ou revenez plus tard.
          </p>
        </div>
      </div>
    );
  ...
  if (filteredSlots.length === 0) {
    return (
      <div className="space-y-6">
        <SlotsFilter onFilterChange={handleFilterChange} totalSlots={slots.length} />
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-gray-600 text-center max-w-md leading-relaxed mb-6">
              Aucun créneau ne correspond aux filtres sélectionnés. Essayez de modifier vos critères
              de recherche.
            </p>
            <button
  ...
  return (
    <div className="space-y-6">
      <SlotsFilter onFilterChange={handleFilterChange} totalSlots={filteredSlots.length} />
