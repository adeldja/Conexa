...
export default function DayGroup({ date, slots, onBookSlot, loading }: DayGroupProps) {
  ...
  const getBadgeColor = (period: string) => {
    switch (period) {
      case 'matin': return 'bg-yellow-100 text-yellow-800 border-yellow-200';
      case 'après-midi': return 'bg-orange-100 text-orange-800 border-orange-200';
      case 'soir': return 'bg-purple-100 text-purple-800 border-purple-200';
        ...
        <div className="p-8">
          {slots.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-gray-500 font-medium">Aucun créneau disponible pour cette journée</p>
            </div>
          ) : (
