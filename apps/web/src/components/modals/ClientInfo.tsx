  ...
  return (
    <div className="bg-blue-50 rounded-lg p-4">
      ...
      <div className="space-y-3">
        <div>
          <label className="block text-sm font-medium text-blue-800 mb-1">Nom complet</label>
        ...
        {notes && (
          <div>
            ...
            <div className="text-sm text-blue-700 bg-white px-3 py-2 rounded border">{notes}</div>
          </div>
        )}
      </div>
    </div>
